...
meeting_list = [
  ...
  { 'name' : 'ICANN57', 
    'location' : {
      ...
      'city' : 'Hyderabad',
      'iata' : 'HYD' },
    'attendee_list' : './examples/ICANN/doc/json/icann57_HYD.json'
  }, 
  { 'name' : 'ICANN58', 
    'location' : {
      'country' : 'Denmark', 
      'city' : 'Copenhagen', 
      'iata' : 'CPH' },
    'attendee_list' : './examples/ICANN/doc/json/icann58_CPH.json'
  },
  { 'name' : 'ICANN59',
    'location' : {
      ...
      'city' : 'Johannesburg ',
      'iata' : 'JNB' },
    'attendee_list' : './examples/ICANN/doc/json/icann59_JNB.json'
  },
  { 'name' : 'ICANN60', 
    'location' : {
      ...
      'city' : 'Abu Dhabi', 
      'iata' : 'AUH' },
    'attendee_list' : './examples/ICANN/doc/json/icann60_AUH.json'
  },
  { 'name' : 'ICANN61', 
    'location' : {
      'country' : 'Puerto Rico', 
      'city' : 'San Juan', 
      'iata' : 'SJU' }, 
    'attendee_list' : './examples/ICANN/doc/json/icann61_SJU.json'
  },
  { 'name' : 'ICANN62', 
    'location' : {
      'country' : 'Panama', 
      'city' : 'Panama', 
      'iata' : 'PTY' },
    'attendee_list' : './examples/ICANN/doc/json/icann62_PTY.json'
  },
  { 'name' : 'ICANN63', 
    'location' : {
      'country' : 'Spain', 
      'city' : 'Barcelona', 
      'iata' : 'BCN' },
    'attendee_list' : './examples/ICANN/doc/json/icann63_BCN.json'
  },
  { 'name' : 'ICANN64', 
    'location' : {
      'country' : 'Japan', 
      'city' : 'Osaka', 
      'iata' : 'OSA' },
    'attendee_list' : './examples/ICANN/doc/json/icann64_KIX.json'
  },
  { 'name' : 'ICANN65', 
    'location' : {
      'country' : 'Morocco',
      'city' : 'Marrakesh',
      'iata' : 'RAK' }, 
    'attendee_list' : './examples/ICANN/doc/json/icann65_RAK.json'
  },
  { 'name' : 'ICANN66', 
    'location' : {
      'country' : 'Canada', 
...
#  meeting = Meeting( **meeting, conf=CONF )
#  print( f"Processing meeting {meeting.name}" )
#  for mode in [ None, 'distance', 'flight', 'attendee' ]:
#    for cluster_key in [ None, 'country', 'flight_segment_number' ]:
#      meeting.plot_co2eq( mode=mode, cluster_key=cluster_key, cluster_nbr=15)
